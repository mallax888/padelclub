      ...
      <body className={inter.className}>
        <ThemeProvider>
          <AuthProvider session={session}>
            {children}
            <Toaster position="bottom-right" toastOptions={{ style: { borderRadius: '8px', background: '#27272A', borderWidth: '1px', borderColor: '#4DFFEE', color: '#F4F4F5', fontSize: '14px' } }} />
            ...
            <div className="tawkto-desktop">
              <Script id="tawkto" strategy="lazyOnload" dangerouslySetInnerHTML={{ __html: `var Tawk_API=Tawk_API||{};(function(){var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];s1.async=true;s1.src="https://embed.tawk.to/6a3ef2c035bb181d4aa8b900/1js2u8gj8";s1.charset="UTF-8";s1.setAttribute("crossorigin","*");s0.parentNode.insertBefore(s1,s0);})();` }} />
            </div>
          </AuthProvider>
        </ThemeProvider>
      </body>
