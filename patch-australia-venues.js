...
// Remove the placeholder Australia venues we added earlier
c = c.replace(/\s*\/\/ ── AUSTRALIA — SYDNEY ──[\s\S]*?\/\/ ── AUSTRALIA — PERTH ──[\s\S]*?\},\n/, '\n');
...
const australiaVenues = `
  ...
  },
  {
    ...
    amenities: [
      ...
      { label: 'Pro shop', icon: 'ti-shopping-bag' },
      { label: 'Coaching available', icon: 'ti-bulb' },
    ],
  },
  // ── AUSTRALIA — MELBOURNE ────────────────────────────────
  {
  ...
  },
  {
    ...
    amenities: [
      ...
      { label: 'Pro shop', icon: 'ti-shopping-bag' },
      { label: 'Snack bar', icon: 'ti-coffee' },
  ...
  },
  {
    ...
    amenities: [
      ...
      { label: 'Curated dining', icon: 'ti-shopping-bag' },
    ],
  },
  {
    slug: 'mel-ipadel',
    ...
    region: 'Melbourne',
    address: 'Unit 6/3B Newlands Road, Reservoir, VIC 3073',
    isLive: false,
    courts: [
